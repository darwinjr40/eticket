            ...
            <div class="card">
                ...
                <div id="contenidoSuperior" class="card-body">
                    ...
                    <section id="izquierda" class="caja">
                        ...
                        <img class="izquierdaClass" src="{{ $imagenes[0]['path'] }}">
                        ...
                        <div id="derecha2" class="derechaClass">
                            <form method="POST" action="{{ route('tickets.addEvento') }}" role="form"
                                ...
                                <div class="derechaCompra">
                                    <select name="ubicacion_id" id="select-ubicaciones" class="form-control select-control"
                                        autofocus required>
                                ...
                                <div id="id-espacios" class="derechaCompra" hidden>
                                    ...
                                    <select name="espacio_id[]" id="select-espacios" class="form-control select-control"
                                        multiple>
                ...
                @if (isset($tickets) && count($tickets) > 0)
                    ...
                    <div style="margin-top: 2%">
                        <table class="table table-striped"
                            style="margin: 10px auto; width: 80%; border: 1px solid black;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($tickets as $ticket)
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST"
                                                action="{{ route('tickets.destroyEvento', $ticket['id']) }}"
                                                role="form" enctype="multipart/form-data">
                                                @csrf
                                                {{-- oculto --}}
                                                <input type="hidden" name="tickets"
                                                    value="{{ json_encode($tickets) }}">
                                                <input id="evento" type="hidden" name="evento_id"
                                                    value="{{ isset($ubicaciones) ? $ubicaciones[0]->evento_id : '' }}">
                                                {{-- button --}}
